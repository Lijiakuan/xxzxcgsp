...
function transValue(tranvalue){
    ...
    $("#input-b9").fileinput('destroy').fileinput({
        language : 'zh',
        uploadUrl : "/zhongyao/admin/upload/files",
        autoReplace : true,
        maxFileCount : 1,
...
$(function () {
    ...
    $.ajax({
        type: "get",
        url: "/zhongyao/getDistGuanlileibie",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/zhongyao/getDistChufangyao",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/zhongyao/getDistBiaozhunwaiguige",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/zhongyao/getDistPizhunshijian",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
...
function downloadFilebyAjax() {
    var url = "/zhongyao/downloadExcel";
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_tasks').bootstrapTable({
            url: '/zhongyao/selectMeds', //请求后台的URL（*）
