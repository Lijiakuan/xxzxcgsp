...
function transValueBook003(idvalue){
    //签字
    //改变记录状态
    ...
    $.ajax({
        ...
        success: function (data1) {
            var opt = {
                url: '/patientappli/getPatientappliByAcceptstatus003',
                query:{
                    pageSize: 10, //页面大小
                    pageNumber: 1, //页码
            ...
            $('#table003').bootstrapTable('refresh',opt);
        },
        error: function () {
            alert("Error");
        }
...
var TableInit003 = function () {
    var oTableInit003 = new Object();
    //初始化Table
    oTableInit003.Init = function () {
        $('#table003').bootstrapTable({
            url: '/patientappli/getPatientappliByAcceptstatus003', //请求后台的URL（*）
            ...
            sortOrder: "asc", //排序方式
            queryParams: oTableInit003.queryParams,//传递参数（*）
            ...
            columns: [
                ...
                {field:'pdfpath',title:'操作',width:100,align:'left',editable:false,sortable:true,formatter:function(value,row,index){
                    ...
                    var temp_html003;
                    temp_html003 = '<button type="button" class="btn btn-xs btn-danger" onclick="transValueBook003('+ tempApplino +')">&nbsp&nbsp&nbsp&nbsp样本签收&nbsp&nbsp&nbsp&nbsp</button>';
                    return temp_html003;
                }},
                {field:'applidate',title:'预约会诊日期',width:120,align:'left',sortable:true,formatter:function(value,row,index){
                    var temp_html = "";
                    var temp_date = value;
                    if(temp_date != null){
    ...
    //得到查询的参数
    oTableInit003.queryParams = function (params) {
        var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            inspdate003: $("#txt_search_inspdate003").val(),
            acceptdate003: $("#txt_search_acceptdate003").val(),
            sortName:this.sortName,
            sortOrder:this.sortOrder
        };
        return temp;
    };
    return oTableInit003;
};
