...
function transValue(tranvalue){
    ...
    $("#input-b9").fileinput('destroy').fileinput({
        language : 'zh',
        uploadUrl : "/shengyao/admin/upload/files",
        autoReplace : true,
        maxFileCount : 1,
...
$(function () {
    ...
    var txt_search_jianyanxiangmu = $("#txt_search_jianyanxiangmu");
    ...
    $.ajax({
        type: "get",
        url: "/shengyao/getDistGuanlileibie",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/shengyao/getDistChufangyao",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/shengyao/getDistBiaozhunwaiguige",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
    ...
    $.ajax({
        type: "get",
        url: "/shengyao/getDistPizhunshijian",
        async: false,
        dataType:"json",
        success: function (data1) {
            var tempValue;
...
function downloadFilebyAjax() {
    var url = "/shengyao/downloadExcel";
    ...
    var jianyanxiangmu=$("#txt_search_jianyanxiangmu").val();
    ...
    form.append($("<input></input>").attr("type", "hidden").attr("name", "jianyanxiangmu").attr("value", jianyanxiangmu));
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_tasks').bootstrapTable({
            url: '/shengyao/selectMeds', //请求后台的URL（*）
            ...
            columns: [
                ...
                {field:'jianyanxiangmu',title:'检查项目',width:100,align:'left',editable:true,sortable:true},
